...
programa a ligar as integrações que já existem no app — **Supabase**, **Vercel** e
**Firecrawl** pelos Conectores do claude.ai, **GitHub** pela credencial da própria
máquina — e que protege para nada sensível ou desnecessário subir ao GitHub. O
...
|---|---|---|
| Conectores Supabase, Vercel e Firecrawl | (do próprio app, nada no plugin) | o Claude inicia o login na própria conversa e te dá o link; aparecem como `claude.ai Supabase`, `claude.ai Vercel`, `claude.ai Firecrawl` |
...
| **4. Confirmação para mudar** | criar, alterar ou apagar qualquer coisa nesses serviços exige mostrar antes e esperar um "sim" | em toda ação que muda algo |
...
**Já conectei o Supabase, a Vercel ou o Firecrawl pelos Conectores do claude.ai.**
Então está feito; a skill reconhece e não pede login de novo.

**Para que serve o Firecrawl?** É a busca e a leitura de páginas da web: pesquisar
preços de concorrentes, ler uma documentação, puxar dados de um site. Entra com
login do GitHub e o plano grátis já serve.
